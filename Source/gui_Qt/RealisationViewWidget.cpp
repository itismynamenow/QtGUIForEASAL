...
void RealisationViewWidget::resizeGL(int w, int h)
{
...
void RealisationViewWidget::updateOrientationSelectionComboBoxValues(std::vector<Orientation *> orientations)
{
...
void RealisationViewWidget::setCayleyPoint(int cayleyPointID, PointType pointType )
{
    atomsB.clear();
...
void RealisationViewWidget::setMolecularUnits(MolecularUnit *molecularUnitA, MolecularUnit *molecularUnitB)
{
    //[ ATLAS NODE]
...
void RealisationViewWidget::transformCylinderAccordingToData(QVector3D positionStart, QVector3D positionEnd,
