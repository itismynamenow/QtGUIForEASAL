...
public:
	 ...
	 */
	PredefinedInteractions(std::vector<std::vector<std::string> > values, size_t labelAcol, size_t labelBcol,size_t radiuscol);
	 ...
	 */
	PredefinedInteractions(std::vector<std::vector<std::string> > values, size_t labelAcol, size_t labelBcol,size_t radiusmincol, size_t radiusmaxcol);
...
private:
	...
	bool find(std::map<std::pair<std::string,std::string>,double > maap ,std::pair<std::string,std::string> val);
