...
public:
	...
	Vector3 operator+(const Vector3& v){
		return Vector3(coord[0]+v.coord[0],coord[1]+v.coord[1],coord[2]+v.coord[2]);
	}
...
public:
	 ...
	 */
	static double* matApp2(double* x,
			double* a, double* b, double* c,
	 ...
	 * @return The transformed location of x
	 */
	static double* newMatApp(double* x,
			double* a, double* b, double* c,
			double* ap,double* bp,double* cp);
	 ...
	 */
	static double* find4thPoint_inTheSamePlane(
				double* a, double* b, double* c,
				double ap,double bp,double cp);
	 ...
	 */
	static void lenToTetra(double* lengths,
	 ...
	 */
	static std::vector<double> getSingleTransformFromTwo(const std::vector<double> &ta, const std::vector<double> &tb);
	 ...
	 */
	static std::vector<double> multiTrans(const std::vector<double> &ta, const std::vector<double> &tb);
	 ...
	 */
	static std::vector<std::vector<double> > getMatrixFromFileMat(const char* filename);
