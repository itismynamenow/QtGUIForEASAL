...
public:
	 ...
	 */
    //static Orientation* computeRealization(ActiveConstraintGraph* cgk, ConvexChart* descr, int flipno, bool& fail);
    //static Orientation* computeRealization(ActiveConstraintGraph* cgk, ConvexChart* descr, int flipno,  double paramconnections[][12], bool& fail ) ;

    static Orientation* computeRealization(ActiveConstraintGraph* cgk, ConvexChart* descr, int flipno, bool& fail, vector<vector<int> > flipScheme);
    static Orientation* computeRealization(ActiveConstraintGraph* cgk, ConvexChart* descr, int flipno,  double paramconnections[][12], bool& fail, vector<vector<int> > flipScheme ) ;
...
private:
	 ...
	 */
	static void locateTetrahedron(int tetrahedron_index, double positions[][3], bool mirror);
	...
	/** false if volume is negative */
	 ...
	 static MolecularUnit* helA , *helB;
