...
public:
	...
	void clear(){
		if(!is_leaf()){
			for(std::list<snode*>::iterator iter = children.begin(); iter != children.end(); iter++){
				(*iter)->clear();
				delete *iter;
			}
		}
...
bool is_collide(Stree *t1, Stree *t2, double fa[][3], double ta[][3], double fb[][3], double tb[][3],double threshold = 0);
bool is_collide(Stree *t1, Stree *t2, std::vector<double> &trans_a, std::vector<double> &trans_b, double threshold = 0);
int count_collision(Stree *t1, Stree *t2, double fa[][3], double ta[][3], double fb[][3], double tb[][3],double threshold = 0);
int count_collision(Stree *t1, Stree *t2, std::vector<double> &trans_a, std::vector<double> &trans_b, double threshold = 0);
