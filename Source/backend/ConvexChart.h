...
public:
     ...
     */
	ConvexChart(ActiveConstraintGraph* cgk, bool dense, CayleyParameterization* cparam, PredefinedInteractions *df);
	 ...
	 */
	int find_pair_in_vector(std::vector<std::pair<int,int> > ivector, std::pair<int,int> ipair);
