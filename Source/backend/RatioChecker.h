...
public:
    ...
    static vector<double> cal_di(MolecularUnit *hel,  PredefinedInteractions *df, const DistinctRealization &r){
        vector<double> res;
    ...
    static string cal_flip_string(MolecularUnit *hel, PredefinedInteractions *df, const DistinctRealization &r){
        //vector<int> res;
        stringstream res;
        vector<Atom*> atoms;
...
public:
    ...
    DistinctRealization(MolecularUnit *hel, PredefinedInteractions *df, double fa[][3], double ta[][3], double fb[][3], double tb[][3],int node, int spacenum, string* fstring = NULL){
        trans_mat = Utils::getSingleTransformFromTwo(Utils::getTransMatrix(fa,ta),Utils::getTransMatrix(fb,tb));
        this->node = node;
    ...
    DistinctRealization(MolecularUnit *hel,  PredefinedInteractions *df, const vector<double> &trans_mat,int node, int spacenum, string* fstring = NULL){
...
//		chull.get_atoms(&atoms);
    ...
    double difference(const DistinctRealization &r1, const DistinctRealization &r2) const{
        double max_dis = 0;
#if 0
    ...
    bool diff_flip(const DistinctRealization &r1, const DistinctRealization &r2) const{
    ...
    bool operator()(const DistinctRealization &r1, const DistinctRealization &r2) const{
...
public:
    RealizationHash(MolecularUnit *hel, DistinctRealization &re):refer(re),rc(hel){
        this->hel = hel;
    }
...
class RatioChecker {
public:
    RatioChecker(SaveLoader* snl, MolecularUnit  *hA, MolecularUnit *hB, Atlas *mapview);
...
private:
    ...
    void preComputeCache(DistinctRealization & correct_dr, vector<AtlasNode*> nodes, PredefinedInteractions *df);
