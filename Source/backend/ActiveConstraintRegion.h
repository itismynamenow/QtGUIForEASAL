...
public:
	...
	std::vector<CayleyPoint*> getValidSpace();
    ...
    void incrementPointsCreated();

    int getPointsCreated();

    int getPointsCreated(int) const;

    void setPointsCreated(int);
	 ...
	 */
	vector<CayleyPoint*> convertSpace(ActiveConstraintRegion* other, vector<pair<int,int> > paramlines, MolecularUnit *helA, MolecularUnit *helB);
    ...
    int pointsCreated = 0; //used because of weirdness with appendWitness
