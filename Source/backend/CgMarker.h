...
public:
	...
	typedef std::set<ActiveConstraintGraph*,bool(*)(ActiveConstraintGraph* , ActiveConstraintGraph* )>::iterator iterator;
...
private:
	...
	std::set<ActiveConstraintGraph*,bool(*)(ActiveConstraintGraph* , ActiveConstraintGraph* )> cgs;
