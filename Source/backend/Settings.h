...
enum Modes {Stopped, TreeSample, ForestSample, ForestSampleAS, BreadthFirst, RefineSampling};
...
namespace Settings {
  ...
  extern bool   createChildren; //todo put it to user input window or not???
    ...
    extern bool   useParticipatingAtomZDistance;
    extern double ParticipatingAtomZDistance;
...
//    extern bool   stericConstraint;
    ...
    extern double bondingLowerLambda;
    extern double bondingLowerDelta;
    extern double bondingUpperLambda;
    extern double bondingUpperDelta;
