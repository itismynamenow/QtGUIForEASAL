...
public:
	...
	ActiveConstraintGraph(std::vector<std::pair<int,int> > &participants, MolecularUnit* helA, MolecularUnit* helB);
     ...
     */
	ActiveConstraintGraph(std::vector<std::pair<int,int> > &participants, MolecularUnit* helA, MolecularUnit* helB, std::vector<std::pair<int,int> > PL);
	 ...
	 */
	MolecularUnit* getMolecularUnitA();

	/**
	 * @brief Getter of MolecularUnit
	 * @return A pointer to this graph's helixB
	 */
	MolecularUnit* getMolecularUnitB();
...
private:
	...
	*/
	 ...
	 */
	vector<int> completeTo3by3Graph_byClosestAtom( MolecularUnit * hel, vector<int> vertices, int size );
     ...
     * @return vector of parameter "atom"s to be added to the vertices of contact graph
	 */
	vector<int> completeTo3by3Graph_that_makes_perpendicularAngle(MolecularUnit * hel, vector<int> vertices, int size);
